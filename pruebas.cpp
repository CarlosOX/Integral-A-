...
int main(){
	...
	cout<<"FUNCION PARA AGREGAR UN ELEMENTO AL ARBOL"<<endl;
	alimentosarbol.add(100);
	
	cout<<alimentosarbol.inorder()<<endl;
	
	cout<<"FUNCION PARA BUSCAR UN ELEMENTO DEL ARBOL (arroja un valor booleano)"<<endl;
	cout<<alimentosarbol.find(40)<<endl;
	
	
	cout<<"FUNCION PARA ELIMINAR UN ELEMENTO DEL ARBOL"<<endl;
	alimentosarbol.remove(300);
	cout<<alimentosarbol.inorder()<<endl;
